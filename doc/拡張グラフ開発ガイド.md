...
var labelsTitles = buckets.labels ? (buckets.labels.count === 1 ? [buckets.labels.title] : buckets.labels.title) : [];
var labelsFieldNames = buckets.labels ? (buckets.labels.count === 1 ? [buckets.labels.fieldName] : buckets.labels.fieldName) : [];
var valueTitles = buckets.value ? (buckets.value.count === 1 ? [buckets.value.title] : buckets.value.title) : [];
var valueFieldNames = buckets.value ? (buckets.value.count === 1 ? [buckets.value.fieldName] : buckets.value.fieldName) : [];
var valueNumberFormats = buckets.value ? (buckets.value.count === 1 ? [buckets.value.numberFormat] : buckets.value.numberFormat) : [];
```
