...
(function() {
	...
	function initCallback(successCallback, initConfig) {
		var busy = ibxBusy.busy.show(true, $(".map-container-frame"));
	...
	function getDefaultUI(renderConfig){
		...
		if(!this.res){
			...
			ibx.resourceMgr.addBundles([{"src":tdgchart.getScriptBasePath()+"tdg/jschart/distribution/extensions/com.ibi.geo.map/lib/runtime_bundle.xml", "loadContext":"ibx"}]).then(
			function(resMgr){				
	...
	var config = {
		id: 'com.ibi.geo.layer',
		containerType: 'html',
        name: 'com.ibi.geo.layer',
        description: 'com.ibi.geo.layer',initCallback: initCallback,
